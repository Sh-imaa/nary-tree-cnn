...
if __name__ == "__main__":
    ...
    parser.add_argument("--l2", type=int, default=0, required=False)
    parser.add_argument("--lr", type=int, default=0.001, required=False)
    parser.add_argument("--dropout1", type=int, default=0.5, required=False)
